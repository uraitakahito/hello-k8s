...
```bash
# Blue
curl http://blue.demo.svc.cluster.local:8080

# Green
curl http://green.demo.svc.cluster.local:8080
```
...
| Service | DNS 名 |
|---------|--------|
| `blue` | `blue.demo.svc.cluster.local` |
| `green` | `green.demo.svc.cluster.local` |
